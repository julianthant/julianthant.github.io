...
export default function Navbar() {
  return (
    <header className="fixed bg-white py-3 inset-x-0 top-0 bottom-auto z-10 border-b-[1px] border-tr border-b-gray drop-shadow-sm">
      <div className="container px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-6 items-center justify-center max-lg:hidden">
            <nav className="border-r border-slate-200 pr-8">
              <ul role="list" className="flex space-x-12 text-slate-600">
